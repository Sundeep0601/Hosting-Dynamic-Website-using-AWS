		...
		<!-- /inner_content-->
				<div class="inner_content">
						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li>Upload Assignment<span></span></li>
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Assignment</h2>
													...
													<div class="forms-main_agileits">
															...
															?>
															 <h3 class="w3_inner_tittle two">Form </h3>
																	<div class="form-body">
																		<form action="assignmentinsert.php" method="post" enctype="multipart/form-data" > <div class="form-group"> 
																		<label for="exampleInputEmail1">Hall-Ticket</label> 
																		<input type="text" class="form-control" required id="exampleInputEmail1" name="hno" required placeholder="Hall-Ticket Number"> </div>
