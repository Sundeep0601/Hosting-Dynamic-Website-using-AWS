...
include("database.php");
	...
	$sql_sel="SELECT * FROM faculty where hname='$name'";
	...
	?>  
													...
													<div class="forms-main_agileits">
														...
														<div class="gallery1">
															<a target="_blank" href="fjords.jpg">
																<img src="<?php echo "album/".$row_sel['image'];?>" height="200" width="300"/>
															</a>
					...
					<p><font color="" size="2px">JNTUH College of Engineering Hyderabad (Autonomous)</font></p><br>
