		...
		<!-- /inner_content-->
				<div class="inner_content">
						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li>Upload Attendance<span></span></li>
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Attendance</h2>
													...
													<div class="forms-main_agileits">
															...
															?>
															 <h3 class="w3_inner_tittle two">Form </h3>
																	<div class="form-body">
																		<form action="attendanceinsert.php" method="post" enctype="multipart/form-data" > <div class="form-group"> 
																		<label for="exampleInputEmail1">Course</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		 ...
																		 <div class="form-group"> <label for="exampleInputEmail1">Date</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<select name="yoa" style="height:50px;width:700px">
